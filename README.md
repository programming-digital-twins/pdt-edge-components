...
# LICENSE
See [LICENSE-DATA](https://github.com/programming-digital-twins/pdt-edge-components/blob/alpha/LICENSE-DATA.md) if you plan to use the non-code resources (sample JSON data files and JSON configuration file).

See [LICENSE-CODE](https://github.com/programming-digital-twins/pdt-edge-components/blob/alpha/LICENSE-CODE) if you plan to use this code (e.g., Python code).
